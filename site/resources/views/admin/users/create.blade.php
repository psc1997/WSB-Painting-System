                            ...
                            <form action="{{ route('users.store') }}" method="POST" name="add_user">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="admin__input-box">
                                        <input type="text" class="form-control admin__input-text" name="name" autocomplete="off" value="{{ old('name') }}" required/>
                                    </div>
                                ...
                                <div class="form-group">
                                    <strong>Email</strong>
                                    <div class="admin__input-box">
                                        <input type="email" class="form-control admin__input-text" name="email" autocomplete="off" value="{{ old('email') }}" required/>
                                    </div>
                                    <span class="text-danger">
                                        {{ $errors->first('email') }}
                                    </span>
                                ...
                                <div class="form-group">
                                    <strong>Hasło</strong>
                                    <div class="admin__input-box">
                                        <input type="password" class="form-control admin__input-text" name="password" autocomplete="off" required/>
                                    </div>
                                    <span class="text-danger">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="admin__input-box">
                                        <input type="password" class="form-control admin__input-text" name="password_confirmation" autocomplete="off" required/>
                                    </div>
                                    <span class="text-danger">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="admin__input-box">
                                        <input type="text" class="form-control admin__input-text" name="city" autocomplete="off" value="{{ old('city') }}"/>
                                    </div>
                                    <span class="text-danger">
                                        {{ $errors->first('city') }}
                                    </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="admin__input-box">
                                        <textarea name="description" class="form-control admin__input-text admin__input-text--textarea" rows="4">{{ old('description') }}</textarea>
                                    </div>
                                    <span class="text-danger">
                                        {{ $errors->first('city') }}
                                    </span>
